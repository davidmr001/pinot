...
public class HelixServerStarter {
  ...
  public HelixServerStarter(String helixClusterName, String zkServer, Configuration pinotHelixProperties)
    ...
    updateInstanceConfigInHelix(NetUtil.getHostnameOrAddress(), adminApiPort, false/*shutDownStatus*/);
  ...
  private void updateInstanceConfigInHelix(String hostname, int adminApiPort, boolean shuttingDown) {
    ...
    propToUpdate.put(CommonConstants.Helix.Instance.HOSTNAME_KEY, hostname);
